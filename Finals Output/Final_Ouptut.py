...
from math import pi, e, log, sin, cos, tan, asin, acos, atan, ceil
...
class HomePage(Frame):
    def __init__(self, MASTER):  # parameter master is where the frame will be place, also, frames are stackable
        ...
        btn_todo = Button(self, text="Planner", padx=5, pady=3, width=20, font=('Roboto Medium', 9),
                          bg="#6A94B5", fg="#D3FFF3", activebackground="#466D86", activeforeground="#D3FFF3",
                          command=lambda: MASTER.switch_frame(Planner))
...
class Planner(Frame):
    def __init__(self, MASTER):
        ...
        "=============================================================================="
        self.location = r"D:Downloads\Planner_Checklist.accdb"
        self.table = "Planner"
        "=============================================================================="
        ...
        self.__btn_back = Button(self, text="Back", activebackground="#466D86",
                                 activeforeground="#D3FFF3", padx=4, pady=3, width=20,
                                 font=self.font, bg="#6A94B5", fg="#D3FFF3",
                                 command=lambda: MASTER.switch_frame(HomePage))
        self.__my_canvas.create_window(300, 375, anchor="center", window=self.__btn_back)
        ...
        self.__my_canvas.create_window(100, 375, anchor="center", window=self.__create_button)
    ...
    def connect(self):
        try:
            connect = pyodbc.connect(
                fr'Driver={"Microsoft Access Driver (*.mdb, *.accdb)"};DBQ={self.location};')
    ...
    def create(self):
        def add():
            ...
            self.__btn_back.config(state=NORMAL)
            self.__btn_state += 1
        ...
        if not self.disable():
            ...
            self.__btn_back.config(state=DISABLED)
            self.__btn_state += 1
